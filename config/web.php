...
//                'dashboard/member/view' => '/member/member/view',
                ...
                'dashboard/member/ppi/index' => '/member/ppi/index',
                'dashboard/member/ppi/create' => 'member/ppi/create',
                'dashboard/member/ppi/update/<id:.*?>' => '/member/ppi/update',
                'dashboard/member/ppi/delete/<id:.*?>' => '/member/ppi/delete',
                'dashboard/member/ppi/trash/<id:.*?>' => '/member/ppi/trash',
                'dashboard/member/ppi/view/<id:.*?>' => '/member/ppi/view',

                'dashboard/member/paskibra/index' => '/member/paskibra/index',
                'dashboard/member/paskibra/create' => 'member/paskibra/create',
                'dashboard/member/paskibra/update' => '/member/paskibra/update',
                'dashboard/member/paskibra/delete' => '/member/paskibra/delete',
                'dashboard/member/paskibra/view' => '/member/paskibra/view',

                'dashboard/member/capas/index' => 'member/capas/index',
                'dashboard/member/capas/create' => 'member/capas/create',
                'dashboard/member/capas/update' => 'member/capas/update',
                'dashboard/member/capas/delete' => 'member/capas/delete',
                'dashboard/member/capas/view' => 'member/capas/view',
                ...
                'dashboard/member/brevetaward/bulk' => '/member/brevetaward/bulk',
                ...
                'dashboard/member/lifeskill/bulk' => '/member/lifeskill/bulk',
                ...
                'dashboard/member/languageskill/bulk' => '/member/languageskill/bulk',
                ...
                'dashboard/member/school/bulk' => '/member/school/bulk',

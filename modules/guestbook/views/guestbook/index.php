...
<div class="row">
    <div class="col-sm-12">
        ...
        GridView::widget([
            ...
            . '&nbsp;&nbsp;'
            . Html::dropDownList('GuestbookSerch[status_filtr1]', '', ['Status', 'Publish' => 'Publish', 'Draft' => 'Draft', 'Unconfirmed' => 'Unconfirmed'], ['class' => 'form-control save-status'])
            . '&nbsp;&nbsp;'
            ...
            . '&nbsp;&nbsp;'
            . Html::dropDownList('GuestbookSerch[status_filtr2]', '', ['Status', 'Publish' => 'Publish', 'Draft' => 'Draft', 'Trash' => 'Trash'], ['class' => 'form-control save-status'])
            . '&nbsp;&nbsp;'
            . Html::submitButton('<i class="fa fa-check"></i> &nbsp;' . Yii::t('app', 'Appley'), ['class' => 'btn btn-primary btn-small'])
            . Html::endTag('div')
            . Html::endTag('div')

...
use app\modules\search\Index\TermsStream\IndexInterface;
use app\modules\search\Index\TermsPriorityQueue;
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class TermStreamsPriorityQueue implements IndexInterface
{

    /**
     * Array of term streams (IndexInterface objects)
     *
     * @var array
     */
     ...
     *
     * @var \app\modules\search\Index\Term
     */
     ...
     * Object constructor
     *
     * @param array $termStreams  array of term streams (IndexInterface objects)
     */
    ...
    public function resetTermsStream()
    {
        ...
        $this->_termsStreamQueue = new TermsPriorityQueue();

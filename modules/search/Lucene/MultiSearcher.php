...
use app\modules\search\app\modules\search\Search\QueryHit;
...
class MultiSearcher implements LuceneInterface
{
     ...
     * Array of LuceneInterface objects
     *
     * @var array
     */
    protected $_indices;
    ...
    public function __construct($indices = array())
    {
        ...
        foreach ($this->_indices as $index) {
            if (!$index instanceof LuceneInterface) {
                throw new Exception('sub-index objects have to implement LuceneInterface.');
            }
        }
    }
     ...
     *    LuceneInterface  callbackFunction(Document $document, array $indices);
     *

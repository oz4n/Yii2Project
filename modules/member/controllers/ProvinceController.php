...
use app\modules\member\form\BulkActionForm;
...
class ProvinceController extends Controller
{
    ...
    {
        $searchModel = new ProvinceSerch;
        $bulkform = new BulkActionForm;
...
//        exit();
     ...
     * @param integer $id
     * @return ProvinceModel the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ProvinceModel::findOne($id)) !== null) {
            return $model;
        } else {

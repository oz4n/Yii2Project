...
<div class="panel">
    <div class="panel-heading">
        <span class="panel-title">Lis data <?= $member ?></span>
    </div>
...
//            echo '<td>' . Html::tag("a", "Tambahkan Photo Tampak Depan", ["href" => 'javascript:undefined;', 'class' => 'edit-front-photo', 'data-type' => 'file', 'data-title' => 'Photo Tampak Depan']) . '</td>';
    ...
    <div class="panel-footer">
        <?php
        $form = ActiveForm::begin(['action' => Url::toRoute(['/member/tools/saveimport', 'action' => 'member-tools-saveimport']), 'options' => ["class" => 'form-inline']])
        ?>
        <?=
        Html::activeHiddenInput($model, 'type_member', ['value' => $member]);
        ?>
        <?=

...
$this->registerJs(
    "$('ul.navigation > li.mm-dropdown > ul > li#member').addClass('active').parent().parent().addClass('open');"
    , View::POS_READY);
?>
...
<div class="row">
    <div class="col-sx-12 col-sm-3 text-center">
        <span class="profile-picture">
            <?=
            Html::img(Yii::getAlias('@web') . '/PixelAdmin/img/profile-pic.jpg', ['id' => 'avatar', 'class' => 'editable img-responsive', 'alt' => $model->name]);
            ?>
		</span>

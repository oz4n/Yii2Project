...
?>
    <div class="col-xs-12 col-sm-8">
        <div class="panel colourable">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'taxonomy_id')->dropDownList(PaskibraSerch::getAreas(), ['id' => 'select-area']) ?>
                <?= $form->field($model, 'tribal_members')->textInput(['maxlength' => 45]) ?>
                <?= $form->field($model, 'school_id')->dropDownList(PaskibraSerch::getSchools(), ['id' => 'select-school']) ?>
                ...
                <?= $form->field($model, 'taxonomies')->dropDownList(PaskibraSerch::getBrevetAwards(), ['multiple' => 'multiple', 'name' => 'PaskibraModel[brevet_award]', 'id' => 'select-brevetawards'])->label('Brevet Penghargaan') ?>
        ...
        <div class="panel colourable">
            ...
            <div class="panel-body">
                ...
                ?>
                <?= $form->field($model, 'year')->dropDownList(PaskibraSerch::getYears(), ['id' => 'select-year', 'maxlength' => 45]) ?>
                <?=
    ...
    <div class="panel colourable">
        ...
        <div class="panel-body">
            ...
            <?php //$form->field($model, 'taxonomies')->checkboxList(PaskibraSerch::getLangSkills())->label('Keterampilan Bahasa Asing') ?>
            <?php //$form->field($model, 'taxonomies')->checkboxList(PaskibraSerch::getLifeSkills())->label('Keterampilan Personal') ?>
            <?php //$form->field($model, 'taxonomies')->checkboxList(PaskibraSerch::getBrevetAwards())->label('Brevet Penghargaan')   ?>
            <?php //$form->field($model, 'taxonomies')->checkboxList(PaskibraSerch::getLangSkills(), ['name' => 'MemberModel[language_skills][]'])->label('Keterampilan Bahasa Asing') ?>
            <div class="form-group field-ppimodel-languageskill">
                <?= Html::activeLabel($model, 'languageskill', ['class' => 'pull-left col-sm-12 ']) ?>

                <div class="col-sm-12">
                    <?= Html::activeDropDownList($model, 'taxonomies', PaskibraSerch::getLangSkills(), ['class' => 'form-control', 'name' => 'PaskibraModel[language_skill][]', 'multiple' => 'multiple', 'id' => 'select-languageskill']) ?>
                </div>
            </div>
            ...
            <div class="form-group field-ppimodel-languageskill">
                ...
                <div class="col-sm-12">
                    <?= Html::activeDropDownList($model, 'taxonomies', PaskibraSerch::getLifeSkills(), ['class' => 'form-control', 'name' => 'PaskibraModel[life_skill][]', 'multiple' => 'multiple', 'id' => 'select-lifeskill']) ?>
                </div>
            </div>
            ...
            <?php //$form->field($model, 'taxonomies')->checkboxList(PaskibraSerch::getLifeSkills(), ['name' => 'MemberModel[life_skills][]'])->label('Keterampilan Personal')   ?>
            <?php //$form->field($model, 'taxonomies')->checkboxList(PaskibraSerch::getBrevetAwards(), ['name' => 'MemberModel[brevet_award][]'])->label('Brevet Penghargaan')   ?>

...
?>
    <div class="col-xs-12 col-sm-8">
        <div class="panel colourable">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'taxonomy_id')->dropDownList(CapasSerch::getAreas(), ['id' => 'select-area']) ?>
                <?= $form->field($model, 'tribal_members')->textInput(['maxlength' => 45]) ?>
                <?= $form->field($model, 'school_id')->dropDownList(CapasSerch::getSchools(), ['id' => 'select-school']) ?>
    ...
    <div class="panel colourable">
        ...
        <div class="panel-body">
            ...
            <?php //$form->field($model, 'taxonomies')->checkboxList(CapasSerch::getLangSkills())->label('Keterampilan Bahasa Asing') ?>
            <?php //$form->field($model, 'taxonomies')->checkboxList(CapasSerch::getLifeSkills())->label('Keterampilan Personal') ?>
            <?php //$form->field($model, 'taxonomies')->checkboxList(CapasSerch::getBrevetAwards())->label('Brevet Penghargaan')   ?>
            <?php //$form->field($model, 'taxonomies')->checkboxList(CapasSerch::getLangSkills(), ['name' => 'MemberModel[language_skills][]'])->label('Keterampilan Bahasa Asing') ?>
            <div class="form-group field-ppimodel-languageskill">
                <?= Html::activeLabel($model, 'languageskill', ['class' => 'pull-left col-sm-12 ']) ?>

                <div class="col-sm-12">
                    <?= Html::activeDropDownList($model, 'taxonomies', CapasSerch::getLangSkills(), ['class' => 'form-control', 'name' => 'CapasModel[language_skill][]', 'multiple' => 'multiple', 'id' => 'select-languageskill']) ?>
                </div>
            </div>
            ...
            <div class="form-group field-ppimodel-languageskill">
                ...
                <div class="col-sm-12">
                    <?= Html::activeDropDownList($model, 'taxonomies', CapasSerch::getLifeSkills(), ['class' => 'form-control', 'name' => 'CapasModel[life_skill][]', 'multiple' => 'multiple', 'id' => 'select-lifeskill']) ?>
                </div>
            </div>
            ...
            <?php //$form->field($model, 'taxonomies')->checkboxList(CapasSerch::getLifeSkills(), ['name' => 'MemberModel[life_skills][]'])->label('Keterampilan Personal')   ?>
            <?php //$form->field($model, 'taxonomies')->checkboxList(CapasSerch::getBrevetAwards(), ['name' => 'MemberModel[brevet_award][]'])->label('Brevet Penghargaan')   ?>

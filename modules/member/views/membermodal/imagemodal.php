...
$this->registerJs(''
                ...
                . '$.ajax({'
                     ...
                     .'success:function(response){'
                        ...
                        .'for (var i = 0; i < response.data.length; i++) {'
                            .'var thumb = "' . Yii::getAlias('@web') . "/resources/images/thumbnail/original/" . '";'
                            .'var src_thumb = "' . Yii::getAlias('@web') . "/resources/images/thumbnail/145x145/" . '";'
                            .'if($("#img-thumbnails").find(\'img[uniquename="\'+response.data[i].unique_name+\'"]\').length === 0){'
                                .'$("#img-thumbnails").append(\'<li><img style="width: 145px; height: 145px;" uniquename="\' + response.data[i].unique_name +\'" data-thumb="\' + thumb + response.data[i].unique_name +\'" alt="\' + response.data[i].name +\'" src="\' + src_thumb + response.data[i].unique_name +\'" uniquename="\' + response.data[i].unique_name +\'" /><div class="tools tools-bottom"><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Perbesar"><i class="fa fa-search-plus"></i></a><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Hapus"><i class="fa fa-times" style="color:#d15b47"></i></a><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Pilih"><i class="fa fa-share"></i></a></div></li>\');'
                            .'}else{'
                                .'console.log(1);'
                            .'}'
                        .'}'
        ...
        . '$("#image-select").on("click",function(){'
            ...
            . 'var img_unique = $("#img-select").attr("uniquename");'
...
$this->registerJs(''
        . 'var formkey = $("#form-search").find(\'input[name="FormSearch[keyword]"]\');'       
        . '$(formkey).bind("keypress", function(){'            
            . 'if($.trim($(formkey).val()).length === 0){'
                . 'console.log("melengo");'
            . '}'
            . '$(formkey).attr("value",$(this).val());'
            . 'var dInput = this.value;'
            . 'console.log(dInput);'
        . '});', View::POS_READY);

/** register js for ajax form serch*/
$this->registerJs(''
        . '$("#form-search").on("submit",function(){'
            . '$("#img-thumbnails").attr("page-data","0");'
            . '$("#loading").css({"display":"block"});'
            . 'var keyword = $(this).find(\'input[name="FormSearch[keyword]"]\');'
            . '$.ajax({'
                    ...
                    . 'dataType:"json",'
                    . 'success: function (response) {'
                        . '$(keyword).attr("value",response.keyword);'
                        . 'console.log(keyword);'
                        ...
                        for (var i = 0; i < response.data.length; i++) {
                            ...
                            var src_thumb = "' . Yii::getAlias('@web') . "/resources/images/thumbnail/145x145/" . '";
                            if($("#img-thumbnails").find(\'img[uniquename="\'+response.data[i].unique_name+\'"]\').length === 0){
                                $("#img-thumbnails").append(\'<li><img style="width: 145px; height: 145px;" uniquename="\' + response.data[i].unique_name +\'"  data-thumb="\' + thumb + response.data[i].unique_name +\'" alt="\' + response.data[i].name +\'" src="\' + src_thumb + response.data[i].unique_name +\'" /><div class="tools tools-bottom"><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Perbesar"><i class="fa fa-search-plus"></i></a><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Hapus"><i class="fa fa-times" style="color:#d15b47"></i></a><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Pilih"><i class="fa fa-share"></i></a></div></li>\');
                            }
                        }'
                        . '$("#loading").css({"display":"none"});'
                    . '}'
...
/**Register js for ajax Album select*/
$this->registerJs(''
...
/**register js for ajax image scroll load*/
$this->registerJs('
    $("#img-thumbnails").slimScroll({
        ...
        if(pos === "bottom"){
           $("#loading").css({"display":"block"});
           var track_load = $("#img-thumbnails").attr("page-data");
           var keyword = $("#form-search").find(\'input[name="FormSearch[keyword]"]\').attr("value");
           $.ajax({
             url:"' . Url::toRoute(['/filemanager/image/loads', 'action' => 'filemanager-image-load']) . '",
             data:{"FormSearch[page]":track_load, "FormSearch[keyword]":keyword},
             dataType:"json",
             success:function(response){
...
/** register  dropzone ajax image upload*/
$this->registerJs('init.push(function () { 
    $("#front-photo-drpopzon").slimScroll({height: 356,railVisible: true });
    var term_id = "";
    ...
    $("#front-photo-drpopzon").dropzone({
            ...
            init:function(){
                ...
                dropZone.on("success",function(file, response){
                   ...
                   img.attr("src",data.thumb_path_145x145 + data.unique_name);
                   var pr = img.parent().parent().parent().parent().find(".progress-bar");
                   pr.css({"display":"none"});
                   $("#img-thumbnails").prepend(\'<li><img style="width: 145px; height: 145px;" data-thumb="\' + data.thumb_path + data.unique_name +\'" alt="\' + data.name +\'" src="\' + data.thumb_path_145x145 + data.unique_name +\'" uniquename="\' + data.unique_name +\'" /><div class="tools tools-bottom"><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Perbesar"><i class="fa fa-search-plus"></i></a><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Hapus"><i class="fa fa-times" style="color:#d15b47"></i></a><a href="javascript:undefined;" class="select-tooltip" data-toggle="tooltip" data-placement="top" data-original-title="Pilih"><i class="fa fa-share"></i></a></div></li>\');
                });
            },
...
/** image select select-tooltip*/
$this->registerJs(
    '$(".select-tooltip").tooltip();'
    .'$("body").on("click",".select-tooltip",function(){'  
        .'$(".select-tooltip").tooltip();'
        .'var img = $(this).parent().parent().find("img");'
        .'$("img#img-select").attr("src","' . Yii::getAlias('@web') . "/resources/images/thumbnail/191x128/" . '" + img.attr("uniquename"));'
        .'$("img#img-select").attr("data-thumb",img.attr("data-thumb"));'
        .'$("img#img-select").attr("uniquename",img.attr("uniquename"));'
    .'});', View::POS_READY);
...
<!--                                <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="list-photo">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group input-group-sm">
                                            <?= Html::activetextInput($model, 'keyword', ["value"=>"",'class' => 'form-control', 'placeholder' => 'Cari']) ?>
                                            <?= Html::activehiddenInput($model, 'page', ["value" => 0]) ?>
                                ...
                                <ul class="ace-thumbnails" id="img-thumbnails" style="margin-left: -3px;" page-data>
                    ...
                    <div class="col-sm-4">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="">
                                    <img id="img-select" style="width: 191px; height: 128px" class="img-thumbnail" src="" alt="">
                                </div>
                                <br>
                                <?= Html::beginForm() ?>
                                <div class="form-group">

    ...
    public function search($params, $pageSize = 20)
    {
        ...
        if (isset($params['MemberSerch']['keyword'])) {
            ...
            $query->orFilterWhere(['like', 'nra', $this->keyword])
                ...
                ->orFilterWhere(['like', 'unit', $this->keyword])

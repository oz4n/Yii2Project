...
/**
 * PaskibraSerch represents the model behind the search form about `app\modules\member\models\PaskibraModel`.
 */
class PaskibraSerch extends PaskibraModel
{
    ...
    {
        $query = PaskibraModel::find();
        if (Yii::$app->user->can('memberviewcreateotheruser')) {
            $query->onCondition([
            ...
            $query->onCondition([
                'type_member' => MEMBER_TYPE_PASKIBRA,
                'user_created' => \Yii::$app->user->identity->getId()
            ]);
        }
        ...
        if (isset($params['PaskibraSerch']['status_filtr1'])) {
            $ss1 = $params['PaskibraSerch']['status_filtr1'];
            $query->orFilterWhere(['like', 'save_status', $ss1]);
        }

        if (isset($params['PaskibraSerch']['status_filtr2'])) {
            $ss2 = $params['PaskibraSerch']['status_filtr2'];
            $query->orFilterWhere(['like', 'save_status', $ss2]);
        }

        if (isset($params['PaskibraSerch']['year_filtr1'])) {
            $this->year_filtr1 = $params['PaskibraSerch']['year_filtr1'];
        }

        if (isset($params['PaskibraSerch']['year_filtr2'])) {
            $this->year_filtr2 = $params['PaskibraSerch']['year_filtr2'];
        }

        if (isset($params['PaskibraSerch']['year_opsi'])) {
            $this->year_opsi = $params['PaskibraSerch']['year_opsi'];
        }
        ...
        if (isset($params['PaskibraSerch']['year_filtr3'])) {
            $this->year_filtr3 = $params['PaskibraSerch']['year_filtr3'];
        }

        if (isset($params['PaskibraSerch']['year_filtr4'])) {
            $this->year_filtr4 = $params['PaskibraSerch']['year_filtr4'];
        }

        if (isset($params['PaskibraSerch']['year_opsi1'])) {
            $this->year_opsi1 = $params['PaskibraSerch']['year_opsi1'];
        }
        ...
        if (isset($params['PaskibraSerch']['keyword'])) {
            $this->keyword = $params['PaskibraSerch']['keyword'];

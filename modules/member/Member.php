...
class Member extends Module implements BootstrapInterface
{
    ...
    public function bootstrap($app)
    {
        $app->getUrlManager()->addRules([
            ...
            'dashboard/member/tool/import/<action:(member-tools-import)>' => '/member/tools/import',
            'dashboard/member/tool/import/next/<action:(member-tools-nextimport)>/<member:.*?>-<uniq:.*?>' => '/member/tools/nextimport',            
            'dashboard/member/tool/export/<action:(member-tools-export)>' => '/member/tools/export'            

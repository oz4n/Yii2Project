...
?>
<?php foreach (RuleSerch::find()->onCondition(['type' => 22])->andFilterWhere(['not in', 'type', 1])->andFilterWhere(['not in', 'type', 2])->all() as $value): ?>
    <div class="tl-entry">                   
        <div class="tl-icon bg-default"><i class="fa fa-dashboard"></i></div>

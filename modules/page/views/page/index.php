...
//    . '$("td").css({"padding-top": "20px"});'    
    . "$('ul.navigation > li.mm-dropdown > ul > li#pages').parent().parent().addClass('active open');"
...
//                        return Html::a('<i class="fa fa-eye"></i>', Url::toRoute(['/page/page/view', 'action' => 'page-view', 'id' => $data->id]), [

...
<div class="col-sm-8">   
    <div id="img-slider" class="img-slider panel"  style="display: <?= $other['imgsliderstatus'] == "Enable" ? "block" : 'none'?>">        
        <div class="alert alert-info" style="border-radius: 0px; moz-border-radius:0px">            
            <strong>Info!</strong> Maksimum ukuran poto lebar 1024 pixel tinggi 384 pixel.
        </div>
        ...
        <div class="panel-footer">
            <button type="button" class="btn" id="test-btn">test</button>
        </div>
        <?php
        $this->registerJs(       
...
//                . 'inputimg.val(inputimg.val() +","+ inputimg.val(txt));'
                . '});'        
        , View::POS_READY);
        ?>
    </div>

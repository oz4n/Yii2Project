...
//        console.log(img.attr("src"));
    ...
    $("#front-photo-drpopzon").slimScroll({height: 316 });
    var term_id = "";
                        ...
                        <div class="tab-content tab-content-bordered" style="padding: 0; border: none">
                            <div class="tab-pane fade active in" id="upload-photo">
                                ...
                                <div class="form-group">
                                    <?= Html::dropDownList('album', '', ImageSearc::getAlbums('Pilih Album'), ['id' => 'select-album-photo', 'class' => 'select-album-photo form-control', 'placeholder' => 'Pilih album']) ?>
                                </div>
                            ...
                            <div class="tab-pane fade" id="list-photo">    
                                <div class="form-group">
                                    <?= Html::dropDownList('album', '', ImageSearc::getAlbums('Pilih Album'), ['id' => 'select-list-album-photo', 'class' => 'select-album-photo form-control', 'placeholder' => 'Pilih album']) ?>
                                </div>
                                ...
                                <div class="text-center" id="loading" style="display: none">
                                    <img src="<?= Yii::getAlias('@web') . "/PixelAdmin/img/loading.gif" ?>">
                                </div>
                            </div>                                
                        </div>  
                        <!--/ .tab-content -->

...
//
    ...
    var demo_themes = [
        {name: 'default', title: 'Default', img: getBaseURL() + 'PixelAdmin/img/themes/default.png'},
        {name: 'asphalt', title: 'Asphalt', img: getBaseURL() +  'PixelAdmin/img/themes/asphalt.png'},
        {name: 'purple-hills', title: 'Purple Hills', img: getBaseURL() + 'PixelAdmin/img/themes/purple-hills.png'},
        {name: 'adminflare', title: 'Adminflare', img: getBaseURL() + 'PixelAdmin/img/themes/adminflare.png'},
        {name: 'dust', title: 'Dust', img: getBaseURL() + 'PixelAdmin/img/themes/dust.png'},
        {name: 'frost', title: 'Frost', img: getBaseURL() + 'PixelAdmin/img/themes/frost.png'},
        {name: 'fresh', title: 'Fresh', img: getBaseURL() + 'PixelAdmin/img/themes/fresh.png'},
        {name: 'silver', title: 'Silver', img: getBaseURL() + 'PixelAdmin/img/themes/silver.png'},
        {name: 'clean', title: 'Clean', img: getBaseURL() + 'PixelAdmin/img/themes/clean.png'},
        {name: 'white', title: 'White', img: getBaseURL() + 'PixelAdmin/img/themes/white.png'}
    ];
